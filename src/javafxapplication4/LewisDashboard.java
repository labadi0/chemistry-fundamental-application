...
/**
 * c'est la classe qui fait la representation de lewis D'un molecule 
...
public class LewisDashboard extends JPanel {
	...
	public LewisDashboard(String symbole) {
			 ...
			 for (int k = 0; k < n2; k++) {
				 ...
				 if ((n1==2) && (n2<=8)&&(n2>4)) {
					...
					/**
                                         ...
                                         * @param g objet  de la classe Graphic 
                                         * @param k parametre a donner quand on fait l'appel de la fontion 
                                         * @param xcenter centre de x quand on dessine electron
                                         * @param ycenter centre de y quand on dessine electron
                                         */
