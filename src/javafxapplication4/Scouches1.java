...
public class Scouches1 {

private int n, s1, s2, p2, s3, p3, s4, d3, p4, s5, d4, p5, s6, f4, d5, p6, s7, f5, d6, p7;

public Scouches1(int n, int s1, int s2, int p2, int s3, int p3, int s4, int d3, int p4, int s5, int d4, int p5, int s6,
 ...
 * @return string
 */
public String calculCouches(int x) {
	...
	return 
			...
			"les sous couches de l'atome  : (1s):"+s1+"(2s):"+s2+"(2p):"+p2+"(3s):"+"\n"+s3+
